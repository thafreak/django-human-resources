...
from human_resources.models import JobOpportunity, NiceToHaves, Candidate, Position, Qualification, Role, ContractType, Evaluation, Interview
from human_resources.forms import EvaluationAddForm
